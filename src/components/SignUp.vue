  ...
  <Form @submit="onSubmit"  v-slot="{ errors }">
    <div class="form-row">
      <div class="form-group col">
        <label>Title</label>
        <Field name="title" as="select" class="form-control" rules="between:0,5" :class="{ 'is-invalid': errors.title }">
          <option value=""></option>
      ...
      <div class="form-group col-5">
        ...
        <Field name="firstName" type="text" class="form-control" rules="between:0,5" :class="{ 'is-invalid': errors.firstName }" />
